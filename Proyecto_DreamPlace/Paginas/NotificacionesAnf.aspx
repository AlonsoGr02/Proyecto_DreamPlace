<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NotificacionesAnf.aspx.cs" Inherits="Proyecto_DreamPlace.Paginas.NotificacionesAnf" %>
        ...
        <div class="container">
            <div class="information">
                <div class="flex-container">
                    ...
                    <asp:Label ID="Labelseparador" runat="server" Text="Notificaciones "></asp:Label>
                </div>
